...
/* harmony import */ var _PanelHeaderCorner__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./PanelHeaderCorner */ "./public/app/features/dashboard/dashgrid/PanelHeader/PanelHeaderCorner.tsx");
/* harmony import */ var _PanelHeaderMenu__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./PanelHeaderMenu */ "./public/app/features/dashboard/dashgrid/PanelHeader/PanelHeaderMenu.tsx");
...
function (_Component) {
  ...
  function PanelHeader() {
    ...
    _this.renderNotice = function (notice) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_5__["Tooltip"], {
        content: notice.text,
        key: notice.severity
  ...
  _createClass(PanelHeader, [{
    ...
    value: function renderLoadingState() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_5__["Tooltip"], {
    ...
    value: function render() {
      ...
      var title = Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_4__["getTemplateSrv"])().replace(panel.title, scopedVars, 'text');
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, data.state === _grafana_data__WEBPACK_IMPORTED_MODULE_3__["LoadingState"].Loading && this.renderLoadingState(), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_PanelHeaderCorner__WEBPACK_IMPORTED_MODULE_7__["default"], {
        panel: panel,
        title: panel.title,
        description: panel.description,
        scopedVars: panel.scopedVars,
        ...
        "aria-label": _grafana_e2e_selectors__WEBPACK_IMPORTED_MODULE_6__["selectors"].components.Panels.Panel.title(title)
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "panel-title"
      }, Object.values(notices).map(this.renderNotice), alertState && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_5__["Icon"], {
      ...
      }, title), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_5__["Icon"], {
        name: "angle-down",
        className: "panel-menu-toggle"
      }), this.state.panelMenuOpen && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_5__["ClickOutsideWrapper"], {
        onClick: this.closeMenu,
        parent: document
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_PanelHeaderMenu__WEBPACK_IMPORTED_MODULE_8__["PanelHeaderMenu"], {
        items: menuItems
...
/* harmony import */ var _components_Inspector_types__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../components/Inspector/types */ "./public/app/features/dashboard/components/Inspector/types.ts");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_Component) {
  ...
  function PanelHeaderCorner() {
    ...
    _this.getInfoContent = function () {
      ...
      var interpolatedMarkdown = Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_3__["getTemplateSrv"])().replace(markdown, panel.scopedVars);
    ...
    _this.onClickError = function () {
      Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_3__["getLocationSrv"])().update({
        ...
        query: {
          ...
          inspectTab: _components_Inspector_types__WEBPACK_IMPORTED_MODULE_5__["InspectTab"].Error
        }
      });
    };
...
/* harmony import */ var app_features_live_dashboard_dashboardWatcher__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! app/features/live/dashboard/dashboardWatcher */ "./public/app/features/live/dashboard/dashboardWatcher.ts");
            ...
            switch (_context.prev = _context.next) {
              ...
              case 33:
                ...
                if (args.routeInfo !== app_types__WEBPACK_IMPORTED_MODULE_4__["DashboardRouteInfo"].New) {
                  Object(_analyticsProcessor__WEBPACK_IMPORTED_MODULE_8__["emitDashboardViewEvent"])(dashboard); // Listen for changes on the current dashboard

                  app_features_live_dashboard_dashboardWatcher__WEBPACK_IMPORTED_MODULE_9__["dashboardWatcher"].watch(dashboard.uid);
                } else {
                  app_features_live_dashboard_dashboardWatcher__WEBPACK_IMPORTED_MODULE_9__["dashboardWatcher"].leave();
                } // yay we are done
...
//# sourceMappingURL=default~DashboardPage~SoloPanelPage.0518489b5f54d842d665.js.map