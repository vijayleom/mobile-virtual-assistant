  ...
  _createClass(UnConnectedAlertTab, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["CustomScrollbar"], {
        ...
        variant: "secondary"
      }, "State history"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Button"], {
        onClick: function onClick() {
          return _this3.onToggleModal('showTestRule');
        },
        variant: "secondary"
      }, "Test rule"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Button"], {
        onClick: function onClick() {
          return _this3.onToggleModal('showDeleteConfirmation');
        },
        variant: "destructive"
      }, "Delete")), !alert && !validationMessage && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(app_core_components_EmptyListCTA_EmptyListCTA__WEBPACK_IMPORTED_MODULE_6__["default"], model)))), this.renderTestRule(), this.renderDeleteConfirmation(), this.renderStateHistory());
    }
  }]);
...
/* harmony import */ var _RowOptions_RowOptionsButton__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../RowOptions/RowOptionsButton */ "./public/app/features/dashboard/components/RowOptions/RowOptionsButton.tsx");
...
function (_React$Component) {
  ...
  function DashboardRow(props) {
    ...
    _this.onDelete = function () {
      app_core_app_events__WEBPACK_IMPORTED_MODULE_3__["default"].emit(app_types__WEBPACK_IMPORTED_MODULE_4__["CoreEvents"].showConfirmModal, {
        title: 'Delete Row',
    ...
    _this.props.dashboard.on(app_types__WEBPACK_IMPORTED_MODULE_4__["CoreEvents"].templateVariableValueUpdated, _this.onVariableUpdated);
  ...
  _createClass(DashboardRow, [{
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      this.props.dashboard.off(app_types__WEBPACK_IMPORTED_MODULE_4__["CoreEvents"].templateVariableValueUpdated, this.onVariableUpdated);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var title = Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_6__["getTemplateSrv"])().replace(this.props.panel.title, this.props.panel.scopedVars, 'text');
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_RowOptions_RowOptionsButton__WEBPACK_IMPORTED_MODULE_5__["RowOptionsButton"], {
...
function (_PureComponent) {
  ...
  function InspectDataTab(props) {
    ...
    _this.exportCsv = function (dataFrame) {
      ...
      var dataFrameCsv = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["toCSV"])([dataFrame], csvConfig);
      var blob = new Blob([String.fromCharCode(0xfeff), dataFrameCsv], {
        type: 'text/csv;charset=utf-8'
      });
      var transformation = transformId !== _grafana_data__WEBPACK_IMPORTED_MODULE_2__["DataTransformerID"].noop ? '-as-' + transformId.toLocaleLowerCase() : '';
      var fileName = "".concat(panel.title, "-data").concat(transformation, "-").concat(Object(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["dateTimeFormat"])(new Date()), ".csv");
      Object(file_saver__WEBPACK_IMPORTED_MODULE_7__["saveAs"])(blob, fileName);
    };

    _this.onDataFrameChange = function (item) {
      _this.setState({
        transformId: item.value === _grafana_data__WEBPACK_IMPORTED_MODULE_2__["DataTransformerID"].seriesToColumns ? _grafana_data__WEBPACK_IMPORTED_MODULE_2__["DataTransformerID"].seriesToColumns : _grafana_data__WEBPACK_IMPORTED_MODULE_2__["DataTransformerID"].noop,
    ...
    _this.state = {
      selectedDataFrame: 0,
      dataFrameIndex: 0,
      transformId: _grafana_data__WEBPACK_IMPORTED_MODULE_2__["DataTransformerID"].noop,
  ...
  _createClass(InspectDataTab, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (prevProps.data !== this.props.data || prevState.transformId !== this.state.transformId) {
        var currentTransform = this.state.transformationOptions.find(function (item) {
          return item.value === _this2.state.transformId;
        });

        if (currentTransform && currentTransform.transformer.id !== _grafana_data__WEBPACK_IMPORTED_MODULE_2__["DataTransformerID"].noop) {
          var selectedDataFrame = this.state.selectedDataFrame;
          var dataFrameIndex = this.state.dataFrameIndex;
          var subscription = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["transformDataFrame"])([currentTransform.transformer], this.props.data).subscribe(function (data) {
            _this2.setState({
    ...
    value: function getProcessedData() {
      ...
      if (!options.withFieldConfig) {
        return Object(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["applyRawFieldOverrides"])(data);
      } // We need to apply field config even though it was already applied in the PanelQueryRunner.
      // That's because transformers create new fields and data frames, so i.e. display processor is no longer there


      return Object(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["applyFieldOverrides"])({
        data: data,
    ...
    value: function getActiveString() {
      ...
      if (selectedDataFrame === _grafana_data__WEBPACK_IMPORTED_MODULE_2__["DataTransformerID"].seriesToColumns) {
        parts.push('Series joined by time');
      } else if (data.length > 1) {
        parts.push(Object(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["getFrameDisplayName"])(data[selectedDataFrame]));
      }
    ...
    value: function renderDataOptions(dataFrames) {
      ...
      var choices = dataSelect.map(function (frame, index) {
        return {
          value: index,
          label: "".concat(Object(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["getFrameDisplayName"])(frame), " (").concat(index, ")")
        };
      });
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(app_core_components_QueryOperationRow_QueryOperationRow__WEBPACK_IMPORTED_MODULE_9__["QueryOperationRow"], {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["VerticalGroup"], {
        spacing: "none"
      }, data.length > 1 && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Field"], {
        ...
        width: 30
      })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["HorizontalGroup"], null, showPanelTransformationsOption && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Field"], {
        label: "Apply panel transformations",
        description: "Table data is displayed with transformations defined in the panel Transform tab."
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Switch"], {
      ...
      })), showFieldConfigsOption && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Field"], {
        ...
        onChange: function onChange() {
          return _this3.setState({
            downloadForExcel: !_this3.state.downloadForExcel
          });
        }
      }))))));
    }
    ...
    value: function render() {
      ...
      if (isLoading) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "Loading ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Icon"], {
          name: "fa fa-spinner",
          className: "fa-spin",
          size: "lg"
        }));
      ...
      var data = dataFrames[index];
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: styles.dataTabContent,
        "aria-label": _grafana_e2e_selectors__WEBPACK_IMPORTED_MODULE_4__["selectors"].components.PanelInspector.Data.content
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: styles.actionsWrapper
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: styles.dataDisplayOptions
      }, this.renderDataOptions(dataFrames)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Button"], {
        variant: "primary",
        onClick: function onClick() {
          return _this4.exportCsv(dataFrames[dataFrameIndex], {
            useExcelHeader: _this4.state.downloadForExcel
          });
        },
        className: Object(emotion__WEBPACK_IMPORTED_MODULE_8__["css"])(_templateObject())
      }, "Download CSV")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Container"], {
        grow: 1
        ...
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Table"], {
          width: width,
          height: height,
          data: data
        }));
...
function buildTransformationOptions() {
  var transformations = [{
    value: _grafana_data__WEBPACK_IMPORTED_MODULE_2__["DataTransformerID"].seriesToColumns,
    label: 'Series joined by time',
    transformer: {
      id: _grafana_data__WEBPACK_IMPORTED_MODULE_2__["DataTransformerID"].seriesToColumns,
      options: {
        byField: 'Time'
      }
    }
...
/* harmony import */ var emotion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! emotion */ "./node_modules/emotion/dist/emotion.esm.js");
/* harmony import */ var _grafana_ui__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @grafana/ui */ "./packages/grafana-ui/src/index.ts");
/* harmony import */ var _panel_editor_QueriesTab__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../panel_editor/QueriesTab */ "./public/app/features/dashboard/panel_editor/QueriesTab.tsx");
/* harmony import */ var app_features_alerting_AlertTab__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! app/features/alerting/AlertTab */ "./public/app/features/alerting/AlertTab.tsx");
/* harmony import */ var _TransformationsEditor_TransformationsEditor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../TransformationsEditor/TransformationsEditor */ "./public/app/features/dashboard/components/TransformationsEditor/TransformationsEditor.tsx");
/* harmony import */ var app_types__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! app/types */ "./public/app/types/index.ts");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./types */ "./public/app/features/dashboard/components/PanelEditor/types.ts");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/*#__PURE__*/
function (_PureComponent) {
  _inherits(PanelEditorTabs, _PureComponent);
  ...
  function PanelEditorTabs() {
    ...
    _classCallCheck(this, PanelEditorTabs);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(PanelEditorTabs)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _this.triggerForceUpdate = function () {
      _this.forceUpdate();
    };

    _this.getCounter = function (tab) {
      var _panel$getTransformat;

      var panel = _this.props.panel;

      switch (tab.id) {
        case _types__WEBPACK_IMPORTED_MODULE_8__["PanelEditorTabId"].Query:
          return panel.targets.length;

        case _types__WEBPACK_IMPORTED_MODULE_8__["PanelEditorTabId"].Alert:
          return panel.alert ? 1 : 0;

        case _types__WEBPACK_IMPORTED_MODULE_8__["PanelEditorTabId"].Transform:
  ...
  _createClass(PanelEditorTabs, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var panel = this.props.panel;
      panel.on(app_types__WEBPACK_IMPORTED_MODULE_7__["CoreEvents"].queryChanged, this.triggerForceUpdate);
      panel.on(app_types__WEBPACK_IMPORTED_MODULE_7__["CoreEvents"].transformationChanged, this.triggerForceUpdate);
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      var panel = this.props.panel;
      panel.off(app_types__WEBPACK_IMPORTED_MODULE_7__["CoreEvents"].queryChanged, this.triggerForceUpdate);
      panel.off(app_types__WEBPACK_IMPORTED_MODULE_7__["CoreEvents"].transformationChanged, this.triggerForceUpdate);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var _this$props = this.props,
          dashboard = _this$props.dashboard,
          _onChangeTab = _this$props.onChangeTab,
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Tab"], {
          ...
          icon: tab.icon,
          counter: _this2.getCounter(tab)
        });
      })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["TabContent"], {
        className: styles.tabContent
      }, activeTab.id === _types__WEBPACK_IMPORTED_MODULE_8__["PanelEditorTabId"].Query && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_panel_editor_QueriesTab__WEBPACK_IMPORTED_MODULE_4__["QueriesTab"], {
        panel: panel,
        dashboard: dashboard
      }), activeTab.id === _types__WEBPACK_IMPORTED_MODULE_8__["PanelEditorTabId"].Alert && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(app_features_alerting_AlertTab__WEBPACK_IMPORTED_MODULE_5__["AlertTab"], {
        panel: panel,
        dashboard: dashboard
      }), activeTab.id === _types__WEBPACK_IMPORTED_MODULE_8__["PanelEditorTabId"].Transform && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_TransformationsEditor_TransformationsEditor__WEBPACK_IMPORTED_MODULE_6__["TransformationsEditor"], {
        panel: panel
      })));
    }
  }]);

  return PanelEditorTabs;
}(react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"]);
...
function (_PureComponent) {
  ...
  function DashboardLinksDashboard() {
    ...
    _this.wrapperRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["createRef"])();
    _this.listItemRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["createRef"])();
    ...
    _this.getDropdownLocationCssClass = function () {
      var pullLeftCssClass = 'pull-left',
          pullRightCssClass = 'pull-right';
      var wrapper = _this.wrapperRef.current;
      var list = _this.listItemRef.current;
    ...
    _this.renderDropdown = function () {
      ...
      var linkElement = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
        ...
        className: 'dropdown-menu ' + _this.getDropdownLocationCssClass(),
        role: "menu",
        ref: _this.listItemRef
...
var TransformationEditor = function TransformationEditor(_ref) {
  var debugMode = _ref.debugMode,
      ...
      _onChange = _ref.onChange;
  var styles = Object(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["useStyles"])(getStyles);
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    var inputTransforms = configs.slice(0, index).map(function (t) {
      return t.transformation;
    });
    var outputTransforms = configs.slice(index, index + 1).map(function (t) {
      return t.transformation;
    });
    var inputSubscription = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_4__["transformDataFrame"])(inputTransforms, data).subscribe(setInput);
    var outputSubscription = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_4__["transformDataFrame"])(inputTransforms, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["mergeMap"])(function (before) {
      return Object(_grafana_data__WEBPACK_IMPORTED_MODULE_4__["transformDataFrame"])(outputTransforms, before);
    })).subscribe(setOutput);
  ...
  var editor = Object(react__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(function () {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(uiConfig.editor, {
      options: _objectSpread({}, uiConfig.transformation.defaultOptions, {}, config.transformation.options),
      input: input,
  ...
  }, [uiConfig.editor, uiConfig.transformation.defaultOptions, config.transformation.id, config.transformation.options, input, _onChange]);
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: styles.editor,
    "aria-label": _grafana_e2e_selectors__WEBPACK_IMPORTED_MODULE_5__["selectors"].components.TransformTab.transformationEditor(uiConfig.name)
  }, editor, debugMode && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: styles.debugWrapper,
    "aria-label": _grafana_e2e_selectors__WEBPACK_IMPORTED_MODULE_5__["selectors"].components.TransformTab.transformationEditorDebugger(uiConfig.name)
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    className: styles.debugJson
  }, output && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["JSONFormatter"], {
    json: output
  })))));
};
...
var getStyles = function getStyles(theme) {
  ...
  return {
    title: Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(_templateObject()),
    name: Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(_templateObject2(), theme.typography.weight.semibold, theme.colors.textBlue),
    iconRow: Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(_templateObject3()),
    icon: Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(_templateObject4(), theme.colors.textWeak, theme.spacing.sm, theme.colors.text),
    editor: Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(_templateObject5()),
    debugWrapper: Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(_templateObject6()),
    debugSeparator: Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(_templateObject7(), theme.spacing.xs, theme.colors.textBlue),
    debugTitle: Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(_templateObject8(), theme.spacing.sm, theme.spacing.xxs, theme.typography.fontFamily.monospace, theme.typography.size.sm, theme.colors.text, debugBorder),
    debug: Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(_templateObject9(), theme.spacing.sm, theme.spacing.sm, theme.spacing.sm, theme.spacing.sm, debugBorder, theme.isLight ? theme.palette.white : theme.palette.gray05, theme.border.radius.sm),
    debugJson: Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(_templateObject10(), theme.spacing.xs)
  };
};
...
var TransformationOperationRow = function TransformationOperationRow(_ref) {
  ...
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_TransformationEditor__WEBPACK_IMPORTED_MODULE_2__["TransformationEditor"], {
    debugMode: showDebug,
    index: index,
    data: data,
    configs: configs,
...
/*!********************************************************************************************************!*\
  !*** ./public/app/features/dashboard/components/TransformationsEditor/TransformationOperationRows.tsx ***!
  \********************************************************************************************************/
/*! exports provided: TransformationOperationRows */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TransformationOperationRows", function() { return TransformationOperationRows; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _grafana_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @grafana/data */ "./packages/grafana-data/src/index.ts");
/* harmony import */ var _TransformationOperationRow__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./TransformationOperationRow */ "./public/app/features/dashboard/components/TransformationsEditor/TransformationOperationRow.tsx");



var TransformationOperationRows = function TransformationOperationRows(_ref) {
  var data = _ref.data,
      onChange = _ref.onChange,
      onRemove = _ref.onRemove,
      configs = _ref.configs;
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, configs.map(function (t, i) {
    var uiConfig = _grafana_data__WEBPACK_IMPORTED_MODULE_1__["standardTransformersRegistry"].getIfExists(t.transformation.id);

    if (!uiConfig) {
      return null;
    }

    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_TransformationOperationRow__WEBPACK_IMPORTED_MODULE_2__["TransformationOperationRow"], {
      index: i,
      id: "".concat(t.id),
      key: "".concat(t.id),
      data: data,
...
/* harmony import */ var _grafana_ui__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @grafana/ui */ "./packages/grafana-ui/src/index.ts");
/* harmony import */ var _grafana_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @grafana/data */ "./packages/grafana-data/src/index.ts");
/* harmony import */ var _core_components_Card_Card__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../core/components/Card/Card */ "./public/app/core/components/Card/Card.tsx");
/* harmony import */ var emotion__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! emotion */ "./node_modules/emotion/dist/emotion.esm.js");
/* harmony import */ var _grafana_e2e_selectors__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @grafana/e2e-selectors */ "./packages/grafana-e2e-selectors/src/index.ts");
/* harmony import */ var app_core_utils_docsLinks__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! app/core/utils/docsLinks */ "./public/app/core/utils/docsLinks.ts");
...
/* harmony import */ var _TransformationOperationRows__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./TransformationOperationRows */ "./public/app/features/dashboard/components/TransformationsEditor/TransformationOperationRows.tsx");
...
function (_React$PureComponent) {
  ...
  function TransformationsEditor(props) {
    ...
    _this.renderTransformationEditors = function () {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_beautiful_dnd__WEBPACK_IMPORTED_MODULE_7__["DragDropContext"], {
        onDragEnd: _this.onDragEnd
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_beautiful_dnd__WEBPACK_IMPORTED_MODULE_7__["Droppable"], {
        droppableId: "transformations-list",
        direction: "vertical"
      }, function (provided) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", _extends({
          ref: provided.innerRef
        }, provided.droppableProps), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_TransformationOperationRows__WEBPACK_IMPORTED_MODULE_8__["TransformationOperationRows"], {
          configs: transformations,
          data: data,
          onRemove: _this.onTransformationRemove,
          onChange: _this.onTransformationChange
  ...
  _createClass(TransformationsEditor, [{
    ...
    value: function renderNoAddedTransformsState() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["VerticalGroup"], {
        ...
        url: Object(app_core_utils_docsLinks__WEBPACK_IMPORTED_MODULE_6__["getDocsLink"])(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["DocsId"].Transformations)
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(TransformationCard, {
          ...
          ariaLabel: _grafana_e2e_selectors__WEBPACK_IMPORTED_MODULE_5__["selectors"].components.TransformTab.newTransform(t.name),
          onClick: function onClick() {
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["CustomScrollbar"], {
        ...
        "aria-label": _grafana_e2e_selectors__WEBPACK_IMPORTED_MODULE_5__["selectors"].components.TransformTab.content
...
var TransformationCard = function TransformationCard(props) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_core_components_Card_Card__WEBPACK_IMPORTED_MODULE_3__["Card"], _extends({}, props, {
...
var getTransformationCardStyles = Object(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["stylesFactory"])(function (theme) {
  return {
    card: Object(emotion__WEBPACK_IMPORTED_MODULE_4__["css"])(_templateObject2(), theme.colors.bg2, theme.spacing.sm, theme.typography.size.md, theme.colors.bg3)
  };
});
...
/* harmony import */ var app_features_live_dashboard_dashboardWatcher__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! app/features/live/dashboard/dashboardWatcher */ "./public/app/features/live/dashboard/dashboardWatcher.ts");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
  ...
  _createClass(DashboardPage, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (!editPanel && urlEditPanelId) {
        app_features_live_dashboard_dashboardWatcher__WEBPACK_IMPORTED_MODULE_19__["dashboardWatcher"].setEditingState(true);
      ...
      if (editPanel && !urlEditPanelId) {
        app_features_live_dashboard_dashboardWatcher__WEBPACK_IMPORTED_MODULE_19__["dashboardWatcher"].setEditingState(false);
        this.setState({
          editPanel: null
        });
      } // entering view mode
...
function (_PureComponent) {
  ...
  function QueriesTab() {
    ...
    _this.onUpdateQueries = function (queries) {
      _this.props.panel.updateQueries(queries); // Need to force update to rerender query rows.
...
/* harmony import */ var _grafana_e2e_selectors__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @grafana/e2e-selectors */ "./packages/grafana-e2e-selectors/src/index.ts");
/* harmony import */ var _plugins_PluginSignatureBadge__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../plugins/PluginSignatureBadge */ "./public/app/features/plugins/PluginSignatureBadge.tsx");
function _templateObject9() {
  var data = _taggedTemplateLiteral(["\n      position: absolute;\n      bottom: ", ";\n      right: ", ";\n      z-index: 1;\n    "]);
...
var PanelPluginBadge = function PanelPluginBadge(_ref2) {
  ...
  if (Object(_plugins_PluginSignatureBadge__WEBPACK_IMPORTED_MODULE_5__["isUnsignedPluginSignature"])(plugin.signature)) {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_plugins_PluginSignatureBadge__WEBPACK_IMPORTED_MODULE_5__["PluginSignatureBadge"], {
...
//# sourceMappingURL=DashboardPage.0518489b5f54d842d665.js.map