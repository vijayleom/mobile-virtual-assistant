...
/*!******************************************************!*\
  !*** ./public/app/features/explore/state/actions.ts ***!
  \******************************************************/
/*! exports provided: addQueryRow, changeDatasource, changeQuery, changeSize, updateTimeRange, changeRefreshInterval, changeDedupStrategy, clearQueries, cancelQueries, loadExploreDatasourcesAndSetDatasource, initializeExplore, loadDatasourceReady, importQueries, loadDatasource, modifyQueries, runQueries, updateRichHistory, deleteRichHistory, toRawTimeRange, stateSave, updateTime, scanStart, setQueries, splitClose, splitOpen, syncTimes, refreshExplore, navigateToExplore */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _utils_decorators__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../utils/decorators */ "./public/app/features/explore/utils/decorators.ts");
/* harmony import */ var _core_copy_appNotification__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../../core/copy/appNotification */ "./public/app/core/copy/appNotification.ts");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread(); }
...
var changeDedupStrategy = function changeDedupStrategy(exploreId, dedupStrategy) {
  return Object(_actionTypes__WEBPACK_IMPORTED_MODULE_9__["changeDedupStrategyAction"])({
    exploreId: exploreId,
...
function initializeExplore(exploreId, datasourceName, queries, range, containerWidth, eventBridge, originPanelId) {
  return (
    /*#__PURE__*/
    function () {
...
var runQueries = function runQueries(exploreId) {
  return function (dispatch, getState) {
    ...
    var datasourceInstance = exploreItemState.datasourceInstance,
        ...
        refreshInterval = exploreItemState.refreshInterval,
        absoluteRange = exploreItemState.absoluteRange;
    ...
    live ? Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["throttleTime"])(500) : rxjs__WEBPACK_IMPORTED_MODULE_1__["identity"], Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (data) {
    ...
    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(_utils_decorators__WEBPACK_IMPORTED_MODULE_18__["decorateWithGraphLogsTraceAndTable"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(_utils_decorators__WEBPACK_IMPORTED_MODULE_18__["decorateWithGraphResult"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(Object(_utils_decorators__WEBPACK_IMPORTED_MODULE_18__["decorateWithLogsResult"])({
      absoluteRange: absoluteRange,
      refreshInterval: refreshInterval
    })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["mergeMap"])(_utils_decorators__WEBPACK_IMPORTED_MODULE_18__["decorateWithTableResult"])).subscribe(function (data) {
      ...
      dispatch(Object(_core_actions__WEBPACK_IMPORTED_MODULE_12__["notifyApp"])(Object(_core_copy_appNotification__WEBPACK_IMPORTED_MODULE_19__["createErrorNotification"])('Query processing error', error)));
      dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_9__["changeLoadingStateAction"])({
        exploreId: exploreId,
        loadingState: _grafana_data__WEBPACK_IMPORTED_MODULE_3__["LoadingState"].Error
      }));
      console.error(error);
    });
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                if (options.range) {
                  urlState.range = options.range.raw; // This is super hacky. In traces to logs we want to create a link but also internally open split window.
                  ...
                  rightState.range = _objectSpread({}, options.range, {
                    raw: {
...
function refreshExplore(exploreId) {
  return function (dispatch, getState) {
    ...
    if (update.datasource) {
      ...
      dispatch(initializeExplore(exploreId, datasource, initialQueries, range, containerWidth, eventBridge, originPanelId));
      return;
    }
...
/*!*********************************************************!*\
  !*** ./public/app/features/explore/utils/decorators.ts ***!
  \*********************************************************/
/*! exports provided: decorateWithGraphLogsTraceAndTable, decorateWithGraphResult, decorateWithTableResult, decorateWithLogsResult */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "decorateWithGraphLogsTraceAndTable", function() { return decorateWithGraphLogsTraceAndTable; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "decorateWithGraphResult", function() { return decorateWithGraphResult; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "decorateWithTableResult", function() { return decorateWithTableResult; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "decorateWithLogsResult", function() { return decorateWithLogsResult; });
...
/* harmony import */ var _plugins_panel_graph2_getGraphSeriesModel__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../plugins/panel/graph2/getGraphSeriesModel */ "./public/app/plugins/panel/graph2/getGraphSeriesModel.ts");
/* harmony import */ var _core_logs_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../core/logs_model */ "./public/app/core/logs_model.ts");
...
var decorateWithGraphLogsTraceAndTable = function decorateWithGraphLogsTraceAndTable(data) {
  var _frame$meta;
...
var decorateWithGraphResult = function decorateWithGraphResult(data) {
  var _ref, _data$request;
  ...
  var graphResult = data.graphFrames.length === 0 ? null : Object(_plugins_panel_graph2_getGraphSeriesModel__WEBPACK_IMPORTED_MODULE_5__["getGraphSeriesModel"])(data.graphFrames, (_ref = (_data$request = data.request) === null || _data$request === void 0 ? void 0 : _data$request.timezone) !== null && _ref !== void 0 ? _ref : 'browser', {}, {
    showBars: false,
    showLines: true,
    showPoints: false
  }, {
...
var decorateWithTableResult = function decorateWithTableResult(data) {
  if (data.error) {
    return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["of"])(_objectSpread({}, data, {
      tableResult: null
    }));
  }
  ...
  var hasOnlyTimeseries = data.tableFrames.every(function (df) {
    return isTimeSeries(df);
  ...
  var transformer = hasOnlyTimeseries ? Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["of"])(data.tableFrames).pipe(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["standardTransformers"].seriesToColumnsTransformer.operator({})) : Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["of"])(data.tableFrames).pipe(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["standardTransformers"].mergeTransformer.operator({}));
  return transformer.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (frames) {
    var frame = frames[0]; // set display processor
    ...
    try {
      for (var _iterator2 = frame.fields[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        var _field$display, _ref2, _data$request2;

        var field = _step2.value;
        field.display = (_field$display = field.display) !== null && _field$display !== void 0 ? _field$display : Object(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["getDisplayProcessor"])({
          field: field,
          theme: _grafana_runtime__WEBPACK_IMPORTED_MODULE_3__["config"].theme,
          timeZone: (_ref2 = (_data$request2 = data.request) === null || _data$request2 === void 0 ? void 0 : _data$request2.timezone) !== null && _ref2 !== void 0 ? _ref2 : 'browser'
        });
      }
    } catch (err) {
...
var decorateWithLogsResult = function decorateWithLogsResult() {
  var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return function (data) {
    var _ref3, _data$request3, _data$request4;
    ...
    var timeZone = (_ref3 = (_data$request3 = data.request) === null || _data$request3 === void 0 ? void 0 : _data$request3.timezone) !== null && _ref3 !== void 0 ? _ref3 : 'browser';
    var intervalMs = (_data$request4 = data.request) === null || _data$request4 === void 0 ? void 0 : _data$request4.intervalMs;
    var newResults = Object(_core_logs_model__WEBPACK_IMPORTED_MODULE_6__["dataFrameToLogsModel"])(data.logsFrames, intervalMs, timeZone, options.absoluteRange);
    var sortOrder = Object(_core_utils_explore__WEBPACK_IMPORTED_MODULE_7__["refreshIntervalToSortOrder"])(options.refreshInterval);
    var sortedNewResults = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["sortLogsResult"])(newResults, sortOrder);
    var rows = sortedNewResults.rows;
    var series = sortedNewResults.series;

    var logsResult = _objectSpread({}, sortedNewResults, {
      rows: rows,
      series: series
    });
...
function isTimeSeries(frame) {
  ...
  var grouped = Object(lodash__WEBPACK_IMPORTED_MODULE_4__["groupBy"])(frame.fields, function (field) {
    return field.type;
  });
  return Boolean(Object.keys(grouped).length === 2 && ((_grouped$FieldType$ti = grouped[_grafana_data__WEBPACK_IMPORTED_MODULE_2__["FieldType"].time]) === null || _grouped$FieldType$ti === void 0 ? void 0 : _grouped$FieldType$ti.length) === 1 && grouped[_grafana_data__WEBPACK_IMPORTED_MODULE_2__["FieldType"].number]);
}
...
//# sourceMappingURL=default~DashboardPage~SoloPanelPage~explore.0518489b5f54d842d665.js.map